...
#     if attention:
#         attentions = torch.stack(output.attentions, dim=0)
#         averaged_attentions = torch.mean(attentions, dim=0)
#         averaged_token_attentions = torch.mean(averaged_attentions, dim=0)
#         token_log_probs = token_log_probs.squeeze(1) * averaged_token_attentions[1:-1]

#     hidden_states = output.hidden_states[-1][:, 1:-1]
#     hidden_state = torch.mean(hidden_states, dim=1).detach().cpu().numpy()
...
# args = argparse.Namespace(lang='ja', method='aula', corpus='ted')
lang='ja'
method='aula'
corpus='news'
